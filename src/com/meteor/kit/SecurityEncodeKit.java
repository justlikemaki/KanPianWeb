...
public class SecurityEncodeKit {
	...
	public static void main(String[] args) {
		//compress("D:\\Development\\WorkSpace\\ideaspace\\javsrc\\WebRoot\\onekeytmp\\FDD-2408","1564");
	}

	public static String sign(String method,String url){
		String oldstr=url+method+DateKit.getStringDateShort();
		oldstr=MD5Encode(oldstr);
		return oldstr;
	}

	public static String sign(String method,String url,String stream){
		String oldstr=stream+url+method;
		oldstr=MD5Encode(oldstr);
		return oldstr;
	}
}