...
$(".searchtag").on("click",function(){
    window.location.href="web/search?sp="+$(this).attr("title");
})
$(".searchtime").on("click",function(){
    window.location.href="web/search?time="+$(this).attr("time");
})
$("#issearch").on("click",function(){
    window.location.href="web/search?sp="+$("#search").val();
})
...
$("#isserchmin").on("click",function(){
    window.location.href="web/search?sp="+$("#searchmin").val();
})
